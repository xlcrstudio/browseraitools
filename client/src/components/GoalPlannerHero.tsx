...
import { Target, CalendarRange, ListChecks, BarChart3, ShieldCheck } from "lucide-react";

export function GoalPlannerHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Goal Planner</span>
      </motion.h1>
      ...
      >
        Turn any ambition into a step-by-step roadmap. Get milestones, timelines, and weekly actions for achieving your biggest goals. Free and instant.
      </motion.p>
      ...
      >
        {[
          { icon: Target, label: "Milestone Breakdown" },
          { icon: CalendarRange, label: "3-12 Month Roadmaps" },
          { icon: ListChecks, label: "Weekly Action Plans" },
