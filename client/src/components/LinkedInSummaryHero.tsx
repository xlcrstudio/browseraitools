...
import { Briefcase, TrendingUp, Layers, Star, ShieldCheck, Sparkles } from "lucide-react";

export function LinkedInSummaryHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">LinkedIn Summary Generator</span>
      </motion.h1>
      ...
      >
        Create a powerful LinkedIn &quot;About&quot; section that gets you noticed. Step-by-step profile builder. 100% private. Runs in your browser.
      </motion.p>
      ...
      >
        {[
          { icon: Briefcase, label: "Personal Brand Builder" },
          { icon: TrendingUp, label: "Keyword Optimized" },
          { icon: Layers, label: "3 Ready-to-Use Versions" },
          { icon: Star, label: "LinkedIn Score" },
