...
import { Mail, Target, ShieldCheck, Zap } from "lucide-react";

export function SalesEmailHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Sales Email</span>{" "}
        Generator
      </motion.h1>
      ...
      >
        Write cold emails that get responses. Generate 5 personalized sales email
        variations with subject lines, spam analysis, and response predictions.
      ...
      >
        {[
          { icon: Zap, label: "5 Email Variations" },
          { icon: Target, label: "Subject Line Optimization" },
