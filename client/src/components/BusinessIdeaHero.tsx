...
import { Lightbulb, TrendingUp, ClipboardList, ShieldCheck } from "lucide-react";

export function BusinessIdeaHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI <span className="text-gradient">Business Idea</span> Generator
      </motion.h1>
      ...
      >
        Discover profitable business ideas tailored to your skills, budget, and
        interests. Get 15+ validated ideas with action plans. Free, private,
        AI-powered.
      </motion.p>
      ...
      >
        {[
          { icon: Lightbulb, label: "15+ Personalized Ideas" },
          { icon: TrendingUp, label: "Viability Scoring" },
          { icon: ClipboardList, label: "Action Plans Included" },
