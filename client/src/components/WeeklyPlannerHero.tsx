...
import { CalendarDays, Clock, Scale, Target, ShieldCheck } from "lucide-react";

export function WeeklyPlannerHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Weekly Planner Generator</span>
      </motion.h1>
      ...
      >
        Create your perfect week in minutes. Get a balanced schedule that fits your goals, priorities, and energy levels. Work smarter, not harder. Free and instant.
      </motion.p>
      ...
      >
        {[
          { icon: CalendarDays, label: "Optimized Schedule" },
          { icon: Clock, label: "Time-Based Planning" },
          { icon: Scale, label: "Work-Life Balance" },
          { icon: Target, label: "Priority-Driven" },
