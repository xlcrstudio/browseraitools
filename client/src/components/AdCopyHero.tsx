...
import { Megaphone, Zap, ShieldCheck, BarChart3 } from "lucide-react";

export function AdCopyHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Ad Copy</span>{" "}
        Generator
      </motion.h1>
      ...
      >
        Create high-converting ad copy for Facebook, Instagram, Google, and LinkedIn.
        Get 5 variations with headlines, body copy, and CTAs.
        Perfect for A/B testing. Free and instant.
      </motion.p>
      ...
      >
        {[
          { icon: Zap, label: "5 Ad Variations" },
          { icon: BarChart3, label: "Conversion Scoring" },
