...
import { RefreshCw, MessageSquare, ShieldCheck } from "lucide-react";

export function ToneConverterHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Tone Converter</span>
      </motion.h1>
      ...
      >
        Transform your message tone instantly. Convert between professional, casual, friendly, formal,
        and more. Perfect for emails, messages, and any written communication. Free and private.
      </motion.p>
      ...
      >
        {[
          { icon: RefreshCw, label: "10+ Tone Options" },
          { icon: MessageSquare, label: "Preserves Your Message" },
