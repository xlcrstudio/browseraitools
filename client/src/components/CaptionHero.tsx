...
import { Camera, Flame, Sparkles, Target, Zap, ShieldCheck } from "lucide-react";
...
export function CaptionHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Instagram Caption Generator</span>
      </motion.h1>
      ...
      >
        Create viral captions instantly. Private AI running in your browser. Feels like a real content creator studio.
      </motion.p>
      ...
      >
        {[
          { icon: Camera, label: "Instagram-Optimized" },
          { icon: Flame, label: "Virality Score" },
          { icon: Sparkles, label: "Emoji Previews" },
          { icon: Target, label: "Style & Audience Match" },
