...
import { UtensilsCrossed, ShoppingCart, Clock, DollarSign, ShieldCheck } from "lucide-react";

export function MealPlannerHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Meal Planner & Grocery List</span>
      </motion.h1>
      ...
      >
        Healthy weekly meals + shopping list in seconds. Free, private, no signup.
      </motion.p>
      ...
      >
        {[
          { icon: UtensilsCrossed, label: "Any Diet" },
          { icon: ShoppingCart, label: "Grocery List" },
          { icon: Clock, label: "Quick Recipes" },
