...
import { MessageSquare, ShieldCheck, Zap, WifiOff } from "lucide-react";

export function MessageAnalyzerHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Message Analyzer</span>
      </motion.h1>
      ...
      >
        Understand the true meaning behind any message -- analyze tone, intent, and hidden signals privately.
        No data leaves your browser. 100% local AI analysis.
      </motion.p>
      ...
      >
        {[
          { icon: ShieldCheck, label: "100% Private & Local" },
