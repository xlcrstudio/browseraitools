...
import { BookOpen, Target, BookMarked, PenTool, ShieldCheck } from "lucide-react";

export function EssayWriterHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Essay Writer</span>
      </motion.h1>
      ...
      >
        Generate well-structured, citation-ready essays with AI -- from argumentative to narrative.
        No data leaves your browser. 100% local AI writing.
      </motion.p>
      ...
      >
        {[
          { icon: BookOpen, label: "Academic Structure" },
          { icon: Target, label: "Strong Thesis" },
          { icon: BookMarked, label: "Citation-Ready" },
          { icon: PenTool, label: "Natural Writing" },
