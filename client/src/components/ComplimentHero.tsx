...
import { Heart, Layers, Smile, Send, ShieldCheck, Sparkles } from "lucide-react";

export function ComplimentHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Compliment Generator</span>
      </motion.h1>
      ...
      >
        Give the perfect compliment in seconds. Heartfelt, funny, or professional — make someone's day instantly. 100% private.
      </motion.p>
      ...
      >
        {[
          { icon: Heart, label: "Warm & Genuine" },
          { icon: Layers, label: "5 Tailored Compliments" },
          { icon: Smile, label: "Multiple Tones" },
          { icon: Send, label: "Ready to Send" },
