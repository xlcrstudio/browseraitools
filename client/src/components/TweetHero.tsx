...
import { Twitter, Ruler, Flame, ListOrdered, Zap, ShieldCheck, Sparkles } from "lucide-react";
...
export function TweetHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Tweet Generator</span>
      </motion.h1>
      ...
      >
        Write viral tweets instantly. Familiar X composer interface. Private AI running in your browser.
      </motion.p>
      ...
      >
        {[
          { icon: Twitter, label: "X/Twitter Style" },
          { icon: Ruler, label: "Character Limit Control" },
          { icon: Flame, label: "Virality Score" },
          { icon: ListOrdered, label: "One-Click Threads" },
