...
import { ListChecks, Clock, BarChart3, Star, CheckSquare, ShieldCheck } from "lucide-react";

export function TodoListHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">To-Do List Generator</span>
      </motion.h1>
      ...
      >
        Turn any goal into a structured, actionable plan with smart task breakdowns, time estimates, and priority levels. Free, private, no signup.
      </motion.p>
      ...
      >
        {[
          { icon: ListChecks, label: "Smart Task Breakdown" },
          { icon: Clock, label: "Time Estimates" },
          { icon: BarChart3, label: "Priority Levels" },
          { icon: CheckSquare, label: "Progress Tracking" },
