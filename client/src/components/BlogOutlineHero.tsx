...
export function BlogOutlineHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Blog Outline</span>{" "}
        Generator
      </motion.h1>
      ...
      >
        Create SEO-optimized blog outlines in seconds. Get title options, structured sections,
        meta descriptions, and content guidance. Free, private, AI-powered.
      </motion.p>
      ...
      >
        {[
          ...
          { icon: FileText, label: "Complete Structure" },
