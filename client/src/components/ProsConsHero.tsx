...
import { Scale, BarChart3, Target, RefreshCw, ShieldCheck, Sparkles } from "lucide-react";

export function ProsConsHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Pros & Cons Generator</span>
      </motion.h1>
      ...
      >
        Get a perfectly balanced analysis for any decision in seconds. Private, objective, and instantly helpful.
      </motion.p>
      ...
      >
        {[
          { icon: Scale, label: "Perfectly Balanced" },
          { icon: BarChart3, label: "Decision Score" },
          { icon: Target, label: "Context-Aware" },
          { icon: RefreshCw, label: "One-Click Refinements" },
