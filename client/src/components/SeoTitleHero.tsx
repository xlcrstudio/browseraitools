...
import { Target, BarChart3, Sparkles, Flame, ShieldCheck } from "lucide-react";

export function SeoTitleHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">SEO Title Generator</span>
      </motion.h1>
      ...
      >
        Generate 10 click-worthy, SEO-optimized titles that rank on Google and drive traffic. Perfect for blogs, products, videos, and landing pages. Instant results with headline scoring.
      </motion.p>
      ...
      >
        {[
          { icon: Target, label: "Character Optimized" },
          { icon: BarChart3, label: "Headline Scoring" },
          { icon: Sparkles, label: "10 Variations" },
          { icon: Flame, label: "Power Words" },
