...
import { TrendingUp, BarChart3, Flame, Zap, Target, ShieldCheck, Sparkles } from "lucide-react";

export function YTTitleHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">YouTube Title Generator</span>
      </motion.h1>
      ...
      >
        Create click-worthy, SEO-optimized YouTube titles that actually rank. Private AI running in your browser. Built like a real growth assistant.
      </motion.p>
      ...
      >
        {[
          { icon: TrendingUp, label: "SEO Score" },
          { icon: BarChart3, label: "Predicted CTR" },
          { icon: Flame, label: "10 Titles Every Time" },
          { icon: Zap, label: "Under 70 Characters" },
          { icon: Target, label: "Style & Category Match" },
