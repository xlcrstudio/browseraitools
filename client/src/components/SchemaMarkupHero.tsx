...
import { Code, CheckCircle, Zap, Copy, ShieldCheck } from "lucide-react";

export function SchemaMarkupHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Schema Markup Generator</span>
      </motion.h1>
      ...
      >
        Generate perfect JSON-LD schema for any page in seconds. FAQ, Article, Product, Recipe & more. Private. Free. Google-ready.
      </motion.p>
      ...
      >
        {[
          { icon: Code, label: "15+ Schema Types" },
          { icon: CheckCircle, label: "Rich Results Ready" },
          { icon: Zap, label: "Instant Generation" },
          { icon: Copy, label: "One-Click Copy" },
