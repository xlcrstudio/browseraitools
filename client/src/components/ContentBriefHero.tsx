...
import { FileText, Search, BarChart3, Target, ShieldCheck, Sparkles } from "lucide-react";

export function ContentBriefHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Content Brief Generator</span>
      </motion.h1>
      ...
      >
        Create complete, SEO-optimized content briefs in minutes. Generate keyword research, content structure, competitor analysis, and writer guidance instantly. Free and powerful.
      </motion.p>
      ...
      >
        {[
          { icon: FileText, label: "Complete Briefs" },
          { icon: Search, label: "SEO Keywords" },
          { icon: BarChart3, label: "Competitor Analysis" },
          { icon: Target, label: "Intent Matching" },
