...
import { FileText, Briefcase, Target, ShieldCheck } from "lucide-react";
...
export function CoverLetterHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        Create personalized, professional cover letters in 30 seconds.
        Tailored to your job, experience, and skills. 100% free, 100% private.
      </motion.p>
      ...
      >
        {[
          { icon: Briefcase, label: "ATS-Optimized" },
          { icon: Target, label: "Personalized to Job" },
