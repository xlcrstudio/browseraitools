...
import { Key, Search, BarChart3, ShieldCheck } from "lucide-react";
...
export function KeywordHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI <span className="text-gradient">Keyword Generator</span>
      </motion.h1>
      ...
      >
        Find high-value SEO keywords in seconds. Get keyword ideas with search
        volume, difficulty scores, and intent classification. Free, private,
        AI-powered.
      </motion.p>
      ...
      >
        {[
          { icon: Key, label: "100+ Keyword Ideas" },
          { icon: Search, label: "Intent Classification" },
          { icon: BarChart3, label: "Difficulty Scores" },
