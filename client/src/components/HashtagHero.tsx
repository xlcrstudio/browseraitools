...
import { Hash, TrendingUp, ShieldCheck } from "lucide-react";

export function HashtagHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Hashtag</span>{" "}
        Generator
      </motion.h1>
      ...
      >
        Generate 30 optimized hashtags for Instagram, TikTok, LinkedIn, and Twitter
        in seconds. Platform-specific strategies, categorized by volume. Free and private.
      </motion.p>
      ...
      >
        {[
          { icon: Hash, label: "30 Optimized Hashtags" },
          { icon: TrendingUp, label: "Platform-Specific" },
