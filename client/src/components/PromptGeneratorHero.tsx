...
import { Wand2, Layers, Zap, Sparkles, ShieldCheck } from "lucide-react";

export function PromptGeneratorHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        Turn any idea into a perfect, high-performance prompt for ChatGPT, Claude & more. Private. Instant. Expert-level.
      </motion.p>
      ...
      >
        {[
          { icon: Wand2, label: "Prompt Engineering Studio" },
          { icon: Layers, label: "3 Prompt Levels" },
          { icon: Zap, label: "Instant Results" },
          { icon: Sparkles, label: "Expert-Level" },
