...
export function LinkedInPostHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">LinkedIn Post</span>{" "}
        Generator
      </motion.h1>
      ...
      >
        Create professional LinkedIn posts that build your brand and drive engagement.
        AI-powered thought leadership content in seconds. Free, private, effective.
      </motion.p>
      ...
      >
        {[
          { icon: Briefcase, label: "Thought Leadership Ready" },
          { icon: TrendingUp, label: "Engagement Optimized" },
