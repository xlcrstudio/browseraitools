...
export function DocumentAnalyzerHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Document Analyzer</span>
      </motion.h1>
      ...
      >
        Upload any PDF or paste text -- get instant private summaries, insights, and explanations.
        No upload to servers. No tracking. Runs 100% in your browser.
      </motion.p>
