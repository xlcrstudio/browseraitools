...
import { Presentation, Zap, ShieldCheck, Timer } from "lucide-react";

export function ElevatorPitchHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Elevator Pitch</span>{" "}
        Generator
      </motion.h1>
      ...
      >
        Perfect your 30-second pitch. Get 5 elevator pitch variations tailored to
        investors, customers, or partners with strength scoring, practice timer,
        and follow-up question prep. Free and private.
      </motion.p>
