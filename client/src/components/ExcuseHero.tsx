...
import { Smile, Briefcase, Sparkles, Zap, ShieldCheck } from "lucide-react";

export function ExcuseHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Excuse Generator</span>
      </motion.h1>
      ...
      >
        Need a quick excuse? Get 5 hilarious, professional, or dramatic ones instantly. Private, fun, and always believable.
      </motion.p>
      ...
      >
        {[
          { icon: Smile, label: "Funny Mode" },
          { icon: Briefcase, label: "Professional Mode" },
          { icon: Sparkles, label: "Dramatic Mode" },
          { icon: Zap, label: "Instant & Believable" },
