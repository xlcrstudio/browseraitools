...
import { Flame, Sparkles, Zap, RefreshCw, ShieldCheck } from "lucide-react";
...
export function RoastHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Roast Generator</span>
      </motion.h1>
      ...
      >
        Get hilariously roasted by AI. Light, Medium, or Savage — your choice. 100% private & instant.
      </motion.p>
      ...
      >
        {[
          { icon: Flame, label: "Comedy Club Vibes" },
          { icon: Sparkles, label: "3 Roast Levels" },
          { icon: Zap, label: "Instant & Shareable" },
          { icon: RefreshCw, label: "Roast Again" },
