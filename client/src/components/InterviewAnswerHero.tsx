...
import { Mic, Target, ShieldCheck } from "lucide-react";

export function InterviewAnswerHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Interview Answer</span>{" "}
        Generator
      </motion.h1>
      ...
      >
        Prepare winning interview answers using the STAR method. Get structured, professional
        answers with delivery tips. Free, private, AI-powered.
      </motion.p>
      ...
      >
        {[
          { icon: Target, label: "STAR Method Structured" },
          { icon: Mic, label: "Delivery Tips Included" },
