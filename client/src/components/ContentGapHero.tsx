...
import { Search, TrendingUp, Brain, ClipboardList, ShieldCheck } from "lucide-react";

export function ContentGapHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Content Gap Analyzer</span>
      </motion.h1>
      ...
      >
        Paste your article + competitor content. Discover every missing topic and keyword opportunity instantly. Private. Free.
      </motion.p>
      ...
      >
        {[
          { icon: Search, label: "Competitor Gap Detection" },
          { icon: TrendingUp, label: "SEO Opportunities" },
          { icon: Brain, label: "Semantic Analysis" },
          { icon: ClipboardList, label: "Content Brief" },
