...
import { Music2, TrendingUp, ShieldCheck } from "lucide-react";

export function TikTokCaptionHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">TikTok Caption</span>{" "}
        Generator
      </motion.h1>
      ...
      >
        Create viral TikTok captions that get you on the FYP. AI-powered hooks,
        hashtags, and CTAs that drive engagement. Free, private, instant.
      </motion.p>
      ...
      >
        {[
          { icon: Music2, label: "Viral Hook Formulas" },
          { icon: TrendingUp, label: "FYP Optimized" },
