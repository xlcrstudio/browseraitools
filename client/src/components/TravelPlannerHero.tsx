...
import { MapPin, Calendar, Luggage, DollarSign, ShieldCheck } from "lucide-react";

export function TravelPlannerHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Travel Itinerary Planner</span>
      </motion.h1>
      ...
      >
        Perfect trip plan in minutes. Free, private, no signup.
      </motion.p>
      ...
      >
        {[
          ...
          { icon: Calendar, label: "Day-by-Day Plan" },
          { icon: Luggage, label: "Packing List" },
