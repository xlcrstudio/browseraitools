...
import { Link2, Target, BarChart3, Search, ShieldCheck, Sparkles } from "lucide-react";

export function InternalLinkHero() {
  return (
    <section className="text-center max-w-3xl mx-auto pt-4 pb-10 md:pt-6 md:pb-14">
      ...
      >
        AI{" "}
        <span className="text-gradient">Internal Link Suggestion Tool</span>
      </motion.h1>
      ...
      >
        Build powerful internal linking structures that boost rankings. AI analyzes your content and suggests strategic internal links with optimized anchor text. Improve crawlability, topical authority, and PageRank distribution.
      </motion.p>
      ...
      >
        {[
          { icon: Link2, label: "Smart Anchor Text" },
          { icon: Target, label: "Relevance Scoring" },
          { icon: BarChart3, label: "Link Density" },
          { icon: Search, label: "Crawlability" },
