import {
  ...
  Scale, ThumbsUp, Swords, ShieldQuestion, Heart, Flame, BookOpenCheck, Sparkles,
} from "lucide-react";
...
export const toolCategories: ToolCategory[] = [
  {
    ...
    tools: [
      ...
      { id: 6, name: "AI Tone Converter", slug: "/tone-converter", icon: Type, available: false },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 15, name: "AI Hashtag Generator", slug: "/hashtag-generator", icon: Hash, available: false },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 20, name: "AI Startup Name Generator", slug: "/startup-name-generator", icon: Rocket, available: false },
      { id: 21, name: "AI Business Idea Generator", slug: "/business-idea-generator", icon: Lightbulb, available: false },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 28, name: "AI Call-to-Action Generator", slug: "/cta-generator", icon: MousePointerClick, available: false },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 32, name: "AI Keyword Generator", slug: "/keyword-generator", icon: Key, available: false },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 36, name: "AI Cover Letter Generator", slug: "/cover-letter-generator", icon: ScrollText, available: false },
      { id: 37, name: "AI LinkedIn Summary Generator", slug: "/linkedin-summary-generator", icon: UserCheck, available: false },
      { id: 38, name: "AI Interview Answer Generator", slug: "/interview-answer-generator", icon: MessageCircle, available: false },
    ],
  },
  {
