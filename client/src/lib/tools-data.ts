import {
  ...
  Scale, ThumbsUp, Swords, ShieldQuestion, Heart, Flame, BookOpenCheck, Sparkles, UtensilsCrossed, MapPin, Code, Terminal, Wand2, Newspaper, Clapperboard, Bot, ScanEye,
} from "lucide-react";
...
export const toolCategories: ToolCategory[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 69, name: "AI Image Analyzer", slug: "/ai-image-analyzer", icon: ScanEye, available: true },
    ],
  },
  {
