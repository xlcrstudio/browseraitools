...
export const pdfSummarizerFAQs: FAQItem[] = [
  {
    question: "Is my PDF uploaded to any server?",
    answer: "No. Your PDF never leaves your browser. The file is read locally using PDF.js (Mozillas open-source PDF renderer), and the AI summary is generated by a model running directly on your device using WebGPU. Zero data is sent to any server.",
  },
  {
    question: "What types of PDFs work best?",
    answer: "Text-based PDFs work best: research papers, reports, ebooks, legal documents, and business documents. Scanned PDFs (image-based) may not extract well since they require OCR, which this tool does not perform. If text is selectable in your PDF viewer, it will extract correctly here.",
  },
  {
    question: "How much of a large PDF can be summarized?",
    answer: "The tool processes the full text extraction for all pages, then summarizes up to approximately 18,000 characters of content. For very long documents, this covers the first portion of the text. A full section-by-section approach works best for academic papers since each section can be analyzed in context.",
  },
  {
    question: "What summary formats are available?",
    answer: "Four formats: Short Summary (2-3 paragraph overview), Key Insights (top 5 data points with page references), Bullet Points (scannable list), and Executive Summary (high-level for decision makers). You can also choose brief, medium, or detailed length.",
  },
  {
    question: "How does the Ask Questions feature work?",
    answer: "After generating a summary, a Q&A panel appears where you can type any question about the document. The AI reads the extracted PDF text and answers based only on the document content — it will not fabricate information that is not present in the PDF.",
  },
  {
    question: "Can I summarize multiple PDFs?",
    answer: "Yes. Click the X button to remove the current PDF, then upload a new one. Each session processes one PDF at a time. All processing stays local in your browser with no file limits or usage caps.",
  },
  {
    question: "Do I need a WebGPU-compatible browser?",
