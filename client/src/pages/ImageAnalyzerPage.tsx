    ...
    <>
      ...
      <section className="text-center mb-10">
        ...
        <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
          Understand what's in any image — objects, text, mood, colors, and composition — powered by Claude Vision. Free, instant, and private.
        </p>
      </section>
      ...
      <section className="mb-10 prose prose-slate dark:prose-invert max-w-none">
        <h2 className="font-display font-bold text-2xl text-slate-800 dark:text-slate-100 mb-4">
          Instant AI Image Analysis — Powered by Claude Vision
        </h2>
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
          The AI Image Analyzer uses Claude Vision to understand your images in seconds. Upload a photo, screenshot, artwork, or product image and get a detailed analysis covering detected objects, visible text, emotional tone, color palette, and more — no account required.
        </p>
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
          Your image is sent only for analysis and never stored or retained. You get actionable insights you can copy and use directly — perfect for content creators, marketers, designers, and anyone who works with visual content.
        </p>
